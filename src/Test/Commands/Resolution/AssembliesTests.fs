module Test.Commands.Resolution.AssembliesTests
...
let private makeProject tempDir projectName =
  ...
  let schemaDirectory = Path.Combine(tempDir, "Schema")
  ...
  { migProject =
    ...
    schemaProjectPath = Path.Combine(schemaDirectory, "Schema.fsproj")

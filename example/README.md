...
2. `DomainModeling/DomainModeling.fsproj` compiles the schema source.
3. `mig codegen` writes `Db.fs` into the domain modeling directory.
...
dotnet fsi build.fsx build-domain-modeling
